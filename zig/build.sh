...
zig build-lib -target wasm32-other-none --release-fast src/allyourargs.zig
zig build-lib -target wasm32-other-none --release-fast src/allyourbase.zig
zig build-lib -target wasm32-other-none --release-fast src/allyourlogs.zig
zig build-lib -target wasm32-other-none --release-fast src/runtime_name.zig
