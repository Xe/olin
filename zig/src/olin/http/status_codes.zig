...
pub fn stringify(inp: status_code) []u8 {
    switch (status_code) {
        StatusCode.Continue => return "Continue",
        StatusCode.SwitchingProtocols => return "SwitchingProtocols",
        StatusCode.OK => return "OK",
        StatusCode.Created => return "Created",
        StatusCode.Accepted => return "Accepted",
        StatusCode.NonAuthoritativeInformation => return "NonAuthoritativeInformation",
        StatusCode.NoContent => return "NoContent",
        StatusCode.ResetContent => return "ResetContent",
        StatusCode.PartialContent => return "PartialContent",
        StatusCode.MultipleChoices => return "MultipleChoices",
        StatusCode.MovedPermanently => return "MovedPermanently",
        StatusCode.Found => return "Found",
        StatusCode.SeeOther => return "SeeOther",
        StatusCode.NotModified => return "NotModified",
        StatusCode.UseProxy => return "UseProxy",
        StatusCode.TemporaryRedirect => return "TemporaryRedirect",
        StatusCode.BadRequest => return "BadRequest",
        StatusCode.Unauthorized => return "Unauthorized",
        StatusCode.PaymentRequired => return "PaymentRequired",
        StatusCode.Forbidden => return "Forbidden",
        StatusCode.NotFound => return "NotFound",
        StatusCode.MethodNotAllowed => return "MethodNotAllowed",
        StatusCode.NotAcceptable => return "NotAcceptable",
        StatusCode.ProxyAuthenticationRequired => return "ProxyAuthenticationRequired",
        StatusCode.RequestTimeout => return "RequestTimeout",
        StatusCode.Conflict => return "Conflict",
        StatusCode.Gone => return "Gone",
        StatusCode.LengthRequired => return "LengthRequired",
        StatusCode.PreconditionFailed => return "PreconditionFailed",
        StatusCode.PayloadTooLarge => return "PayloadTooLarge",
        StatusCode.URITooLong => return "URITooLong",
        StatusCode.UnsupportedMediaType => return "UnsupportedMediaType",
        StatusCode.RangeNotSatisfiable => return "RangeNotSatisfiable",
        StatusCode.ExpectationFailed => return "ExpectationFailed",
        StatusCode.Imateapot => return "Imateapot",
        StatusCode.UpgradeRequired => return "UpgradeRequired",
        StatusCode.InternalServerError => return "InternalServerError",
        StatusCode.NotImplemented => return "NotImplemented",
        StatusCode.BadGateway => return "BadGateway",
        StatusCode.ServiceUnavailable => return "ServiceUnavailable",
        StatusCode.GatewayTimeout => return "GatewayTimeout",
        StatusCode.HTTPVersionNotSupported => return "HTTPVersionNotSupported",
        StatusCode.Processing => return "Processing",
        StatusCode.MultiStatus => return "MultiStatus",
        StatusCode.IMUsed => return "IMUsed",
        StatusCode.PermanentRedirect => return "PermanentRedirect",
        StatusCode.UnprocessableEntity => return "UnprocessableEntity",
        StatusCode.Locked => return "Locked",
        StatusCode.FailedDependency => return "FailedDependency",
        StatusCode.PreconditionRequired => return "PreconditionRequired",
        StatusCode.TooManyRequests => return "TooManyRequests",
        StatusCode.RequestHeaderFieldsTooLarge => return "RequestHeaderFieldsTooLarge",
        StatusCode.UnavailableForLegalReasons => return "UnavailableForLegalReasons",
        StatusCode.VariantAlsoNegotiates => return "VariantAlsoNegotiates",
        StatusCode.InsufficientStorage => return "InsufficientStorage",
        StatusCode.NetworkAuthenticationRequired => return "NetworkAuthenticationRequired",
    }
    return "Unknown";
}
